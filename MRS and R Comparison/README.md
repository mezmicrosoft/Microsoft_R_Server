...
The **Total Execution Time Breakdown** indicates the _Join Data_, _Edit Metadata_ and _Train Model_ steps take the major percentage of the total execution time.
